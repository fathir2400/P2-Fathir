        ...
        <div class="xl:col-span-8 col-span-12">
            <div class="box custom-box shadow-lg rounded-md">
                <div class="box-header flex justify-between">
                    ...
                    <a href="{{ route('kitchen.invoice') }}" class="ti-btn ti-btn-secondary-full" style="padding: 2px 6px; font-size: 0.75rem;">
                        Invoice
                ...
                <div class="box-body p-4">
                    <form id="user-form" method="POST" action="{{ route('Users.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="role" value="kitchen" readonly>
                        </div>
                        <div class="mb-3">
