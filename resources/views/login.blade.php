...
<!-- Mirrored from spruko.com/demo/valex/tailwind/dist/html/sign-in-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 May 2024 02:12:18 GMT -->
<head>
            ...
            <div class="xxl:col-span-4 xl:col-span-4 lg:col-span-4 md:col-span-6 sm:col-span-8 col-span-12">
                ...
                <div class="box">
                    <div class="box-body !p-[3rem]">
                        ...
                        <p class="mb-4 text-[#8c9097] opacity-[0.7] font-normal text-center">Welcome!</p>
                        @if($errors->any())
                        ...
                        <div class="grid grid-cols-12 gap-y-4">
                            ...
                            <input type="email" value="{{ old('email' )}}" name="email" class="form-control " placeholder="user name">
                            </div>
                            <div class="xl:col-span-12 col-span-12">
                            ...
                            <a href="{{'/'}}" class="ti-btn ti-btn-lg bg-secondary text-white !font-medium dark:border-defaultborder/10">Back</a>
                            </div>
                        </div>
